...
export const habitIconOptions: Array<{ value: HabitIcon; label: string }> = [
  ...
  { value: 'bed-double', label: 'Sleep' },
  { value: 'bike', label: 'Cycling' },
  { value: 'book-heart', label: 'Journal' },
  { value: 'brush-cleaning', label: 'Tidy' },
  { value: 'calendar-check-2', label: 'Plan' },
  { value: 'camera', label: 'Capture' },
  { value: 'chef-hat', label: 'Cook' },
  { value: 'circle-gauge', label: 'Progress' },
  { value: 'coffee', label: 'Coffee' },
  { value: 'heart-handshake', label: 'Care' },
  { value: 'languages', label: 'Language' },
  { value: 'music-2', label: 'Music' },
  { value: 'notebook-pen', label: 'Write' },
  { value: 'pill', label: 'Medication' },
  { value: 'sun', label: 'Morning' },
  { value: 'utensils', label: 'Meals' },
  { value: 'wallet-cards', label: 'Budget' },
]
